...
<p>
    <a href="#"><img alt="Vue" src="https://img.shields.io/badge/Vue-35495E.svg?logo=vuedotjs&logoColor=4FC08D"></a>
    ...
    <a href="#"><img alt="Apollo GraphQL" src="https://img.shields.io/badge/Apollo_GraphQL-311C87.svg?logo=apollo-graphql&logoColor=white"></a>
</p>
...
<p>
    ...
    <a href="#"><img alt="NeonDB" src="https://img.shields.io/badge/NeonDB-000000.svg?logo=data:image/svg+xml;base64,PHN2ZyBmaWxsPSIjMDBmZmZmIiB2aWV3Qm94PSIwIDAgMjQgMjQiPjxwYXRoIGQ9Ik00IDE1LjVMMTAgNy40TDE0LjUgMTAuNUwyMCAxNCIvPjwvc3ZnPg=="></a>
...
### ☁️ AWS Services
`EC2` `S3` `IAM` `Lambda` `ECS` `DynamoDB` `API Gateway` `VPC`
